...
def build_agent(api_key: str):
    ...
    # Define properly named tools (fixes repo_browser._list_files error)
    shared_tools = [
        Tool(name="read_file", func=read_file.run, description="Read a file from project"),
        Tool(name="write_file", func=write_file.run, description="Write content to a file in the project"),
        Tool(name="list_files", func=list_files.run, description="List files in current project directory"),
        Tool(name="get_current_directory", func=get_current_directory.run, description="Return current working directory"),
    ]
    ...
    def coder_agent(state: dict) -> dict:
        ...
        # react_agent = create_agent(llm, shared_tools)
        react_agent = create_agent(llm, tools=shared_tools)
